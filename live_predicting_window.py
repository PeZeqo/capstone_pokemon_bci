# live predicting window, but import csv as user input
# I want the arrows to point to where the correct input is
# perhaps a square around the chosen input 

# no cortex needeed? and im not recording
# instead of export_recording, import_recording
...
class live_predicting_window(arcade.Window):
    ...
    def handle_recording(self):
        ...
        # finished running through csv file
        if:
        	self.exit_window()
...
if __name__ == "__main__":
    ...
    window = live_predicting_window(0, 0, "Prediction Window")
    window.setup()
    arcade.run()